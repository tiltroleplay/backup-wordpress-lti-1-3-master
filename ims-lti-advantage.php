...
{
    // error_log( 'public key for testing: '.print_r($row->public_key, true));
    echo "<table class='form-table'>\n";
    echo "<tr><th>" . __('Client id',
...
// Extract the public key from $res to $pubKey
    ...
    // var_dump( trim( $pubKey ) );
    // var_dump( trim( $privKey ) );

    // $pubKey = file_get_contents( dirname(__FILE__).'/keys/publicDCU.pem' );
    // $privKey = file_get_contents( dirname(__FILE__).'/keys/privateDCU.pem' );
